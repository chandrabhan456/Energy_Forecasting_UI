...
const LineGraph1 = ({ data, ModelName }) => {
  ...
  const handleDownloadPDF = async () => {
    ...
    pdf.text(subtitleText, (pageWidth - pdf.getTextWidth(subtitleText)) / 2, 80);
    ...
    pdf.text(subtitleText1, (pageWidth - pdf.getTextWidth(subtitleText1)) / 2, 290);
